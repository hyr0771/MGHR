...
# os.environ["HF_ENDPOINT"] = "https://hf-mirror.com"  # 或通过配置文件设置
...
class ISubGVQA(torch.nn.Module):
    ...
    def __init__(
        ...
        self.scene_graph_encoder = SceneGraphEncoder(
            hidden_dim=self.general_hidden_dim, dist=args.distributed,dataset=args.dataset
        )

        self.text_emb_dim = 512
        # clip_model = CLIPModel.from_pretrained("openai/clip-vit-base-patch32")
        clip_model = CLIPModel.from_pretrained(args.clip_url)
        ...
        self.gat_seq = MGAT(
            ...
            num_ins=args.mgat_layers,   # default=4
        ...
        # VQA 3129
        if args.dataset == "GQA":
            num_short_answer_choices = 1533  # hard coding
        elif args.dataset == "VQA":
            num_short_answer_choices = 3129  # hard coding
        else:
            num_short_answer_choices = 1533  # hard coding
    ...
    def forward(
        ...
        instr_vectors = self.instr_reduction(qst_feats)     #(B,300)
