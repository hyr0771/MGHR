...
from xvlm.dataset.re_dataset import re_train_dataset, re_eval_dataset
from xvlm.dataset.pretrain_dataset import ImageTextJsonDataset, RegionTextJsonDataset
from xvlm.dataset.nlvr_dataset import nlvr_dataset
from xvlm.dataset.vqa_dataset import vqa_dataset
from xvlm.dataset.grounding_dataset import grounding_dataset, grounding_dataset_bbox
from xvlm.dataset.coco_karpathy_dataset import coco_karpathy_train, coco_karpathy_train_scst, coco_karpathy_caption_eval


from xvlm.dataset.randaugment import RandomAugment
...
def create_dataset(dataset, config, evaluate=False):
    ...
    if dataset == 'pretrain':
        ...
        """
            config['test_file'] ---> data/finetune/vqa_test.json
            config['vqa_root'] ---> images/coco/
            config['vg_root'] ---> images/visualgenome/
            config['answer_list']  ---> data/finetune/answer_list.json
